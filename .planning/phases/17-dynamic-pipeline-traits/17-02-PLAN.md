...
<task type="auto">
  ...
  <files>app/components/pipeline-builder/agent-node.tsx, app/components/pipeline-builder/traits-context.tsx, app/routes/pipelines.new.tsx, app/routes/pipelines.$id.tsx</files>
  <action>
Update AgentNode to:
...
Create a dedicated context file `app/components/pipeline-builder/traits-context.tsx`:
```typescript
