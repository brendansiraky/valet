...
5. Export the hook and types.
  ...
  <done>usePipelineFlow hook exists with full TypeScript typing, implements all required callbacks, and properly manages React Query cache with debounced saves</done>
</task>
...
4. No changes to existing component behavior (hook is not used yet)
</verification>
...
4. No runtime regressions (components still use Zustand for now)
</success_criteria>
